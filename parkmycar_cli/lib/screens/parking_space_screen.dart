...
void screenAddParkingSpace() async {
  ...
  try {
    ParkingSpace? parkingSpace = await ParkingSpaceHttpRepository.instance
...
void screenUpdateParkingSpace() async {
  ...
  try {
    await ParkingSpaceHttpRepository.instance.getById(id);
  } catch (e) {
...
void screenDeleteParkingSpace() async {
  ...
  try {
    await ParkingSpaceHttpRepository.instance.delete(id);
