...
void screenAddVehicle() async {
  ...
  try {
    Vehicle? vehicle = await VehicleHttpRepository.instance
        .create(Vehicle(regNr, personId, type));
...
void screenShowAllVehicles() async {
  ...
  List<Vehicle> vehicles = await VehicleHttpRepository.instance.getAll();
...
void screenUpdateVehicle() async {
  ...
  try {
    await VehicleHttpRepository.instance.getById(id);
  } catch (e) {
...
void screenDeleteVehicle() async {
  ...
  try {
    await VehicleHttpRepository.instance.delete(id);
